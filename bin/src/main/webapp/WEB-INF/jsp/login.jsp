    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<div class="form-group">
				<label class="col-sm-4 col-md-4 col-lg-4 control-label" for="userEmail">Nombre</label>
				<div class="col-sm-8 col-md-6 col-lg-6">
					<input id="mail" name="mail" class="form-control" ng-model="loginUser.email" type="text" required="required"/>
				</div>
			</div>			
	 		<div class="form-group">
				<label class="col-sm-4 col-md-4 col-lg-4 control-label" for="userPassword">Contraseña</label>
				<div class="col-sm-8 col-md-6 col-lg-6">
					<input id="password" name="password" class="form-control" ng-model="loginUser.password" type="password" required="required"/>	
				</div>
			</div>
