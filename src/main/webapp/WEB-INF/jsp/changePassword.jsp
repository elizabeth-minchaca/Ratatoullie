		...
		<div class="modal-content">
			<form  id="passChangeForm" ng-submit="submitChangePassword()" class="form-horizontal">
				<div class="modal-header">
					...
					<h4 class="modal-title"><span class="glyphicon glyphicon-edit"></span> <strong>Cambiar Contraseña</strong></h4>
				</div>
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-9">
							<input id="passActual" required="required" type="password"
								class="form-control"  ng-model="oldPassword">
						</div>
					</div>
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-9">
							<input id="passChangeNueva" required="required" type="password"
								class="form-control"  ng-model="newPassword">
						</div>
					</div>
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-9">
							...
							class="form-control" ng-model="newPassword2">
						</div>
					</div>
